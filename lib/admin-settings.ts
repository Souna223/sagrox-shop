...
export const settingsSchema = z.object({
  ...
  freeShippingService: z.string().trim().max(80, "Nome muito longo.").default("Frete Grátis"),
  freeShippingDeliveryDays: z.coerce.number().int().min(1, "Prazo inválido.").default(5),
